...
VALUES ('user1', '$2a$10$R.5gHT4DcYZPkMqHW6XeR.wuK5bkRe8eF2JcPMxbrC8hn2U34snDG', 'USER'),  -- Password: user1
       ...
       ('superadmin', '$2a$10$YnB2tsoA/Qj677ct/NDVd.XysULfImMxgjg7POfHSfsnY448dMnUG', 'SUPERADMIN');
-- Password: superadmin
...
INSERT INTO prices (brand_id, product_id, price_list, start_date, end_date, priority, price, curr)
VALUES (1, 35456, 1, '2020-06-14 00:00:00', '2020-12-31 23:59:59', 0, 35.50, 'EUR'),
